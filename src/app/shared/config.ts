...
let api = 'https://www.isithebe.ndu-systems.net/api';
let web = 'https://www.isithebe.ndu-systems.net';
if (IS_LOCAL) {
...
export const SELECTED_CLIENT_BENEFICIARY = 'selectedClientBenefitiary';
