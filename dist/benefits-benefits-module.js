...
var BenefitsListComponent = /** @class */ (function () {
    function BenefitsListComponent() {
    }
...
/***/ "./src/app/views/benefits/benefits-list/index.ts":
/*!*******************************************************!*\
  !*** ./src/app/views/benefits/benefits-list/index.ts ***!
  \*******************************************************/
/*! exports provided: BenefitsListComponent */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _benefits_list_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./benefits-list.component */ "./src/app/views/benefits/benefits-list/benefits-list.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BenefitsListComponent", function() { return _benefits_list_component__WEBPACK_IMPORTED_MODULE_0__["BenefitsListComponent"]; });
...
/* harmony import */ var _benefits_routing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./benefits.routing */ "./src/app/views/benefits/benefits.routing.ts");
/* harmony import */ var _benefits_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./benefits-list */ "./src/app/views/benefits/benefits-list/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BenefitsModule = /** @class */ (function () {
    ...
    BenefitsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _benefits_routing__WEBPACK_IMPORTED_MODULE_3__["BenefitsRoutes"]
            ],
            declarations: [_benefits_component__WEBPACK_IMPORTED_MODULE_2__["BenefitsComponent"], _benefits_list__WEBPACK_IMPORTED_MODULE_4__["BenefitsListComponent"]]
        })
    ], BenefitsModule);
...
/*!****************************************************!*\
  !*** ./src/app/views/benefits/benefits.routing.ts ***!
  \****************************************************/
/*! exports provided: BenefitsRoutes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
